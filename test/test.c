...
//     TEST_ROUNDTRIP("false");
//     TEST_ROUNDTRIP("true");
//     TEST_ROUNDTRIP("12452");
//     // TEST_ROUNDTRIP("0.141");
//     // TEST_ROUNDTRIP("9E12");
//     TEST_ROUNDTRIP("-1090");
//     TEST_ROUNDTRIP("\"\\n \\f \\t \\\\ afds\"");
//     TEST_ROUNDTRIP("\" hello yuxintao \"");
//     TEST_ROUNDTRIP("[1,2,3]");
//     TEST_ROUNDTRIP("[[1,2],1,2]");
//     TEST_ROUNDTRIP("[[],1,2]");
//     TEST_ROUNDTRIP("{\"hello\":{},\"hello\":{},\"hello\":[1]}");
//     TEST_ROUNDTRIP("{\"hello\":123}");
//     TEST_ROUNDTRIP("{\"ni\":[]}");
//     TEST_ROUNDTRIP("{\"123\":{}}");
